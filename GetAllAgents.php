...
if (isset($_POST['edit'])) {
  ...
  $_SESSION['tempIdAgent'] = $itemId;

  header("Location: PostAgentForm.php?edit=true");
  ...
  $results = DELETE_ONE_CurlAPIRequest($APIAgentFetchURL, $itemId);
  ...
  <tbody>
    ...
    <?php foreach ($GET_requestAgentData as $oneAgent):?> 
      ...
      <tr>
        ...
        <td style="text-transform: uppercase;"><?= $oneAgent["reLicense"];?></td>
